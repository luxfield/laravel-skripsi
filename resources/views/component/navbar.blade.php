<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    ...
    <a href="{{ route('home') }}" class="flex items-center">
        ...
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PT. Pacitan Seribu Satu Goa</span>
    </a>
    <div class="flex items-center md:order-2">
        ...
        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
          <div class="px-4 py-3">
            ...
            <span class="block text-sm font-medium text-gray-500 truncate dark:text-gray-400">{{ $email_user }}</span>
          </div>
