...
<div class="overflow-y-auto relative w-full">
    <h2 class="text-4xl font-extrabold dark:text-white">Barang Keluar</h2>
    <form>
        <div class="relative my-3">
            ...
            <input type="search" id="searchSlip"
                ...
                placeholder="Masukkan nomor slip" required>
            <button type="submit"
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400" id="tabelSlip">
